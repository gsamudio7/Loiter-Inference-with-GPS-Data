...
```{r plotInit, cache=FALSE, echo=FALSE, fig.cap="",out.height=600}
...
```{r extraction, cache=FALSE, class.source="chunk", fig.align="center", fig.width=15, echo=TRUE, fig.cap=""}
...
```{r transform, cache=FALSE, class.source='chunk'}
...
```{r load, cache=FALSE, class.source="chunk",fig.cap=""}
...
```{r collectionAnalysis,echo=FALSE,cache=FALSE,class.source="chunk",fig.align="center",fig.cap="<b>Figure 1: </b>Collection Volume by Hour and Weekday"}
...
# 
# # Plot 
# weekday_and_hour_volume <- plot_ly(dt, x = dt[,Hour], y = dt[,Weekday], 
...
```{r collectionAnalysis2, echo=FALSE,cache=FALSE, class.source="chunk", fig.align="center",fig.cap="<b>Figure 2: </b>Collection Volume over Time"}
...
```{r dataProcess, class.source='chunk', echo=FALSE, cache=FALSE,fig.align="center",fig.cap="<b>Figure 3: </b>Inter-observation Time Histogram"}
...
# 
# # Plot
# inter_obs_time <- plot_ly(x=dt[,timeInt] %>% na.omit() %>% as.double() %>% log10(),
#         type = "histogram",
#         color=I("#990000"),
#         nbinsx=100,
...
#                        x = log10(qt.95) + 0.2, y = 10500, showarrow=FALSE)) %>% plotly_build()
# 
...
```{r epsSpatialDist, echo=FALSE,cache=FALSE, class.source="chunk",fig.align="center",fig.cap="<b>Figure 4: </b>Sorted Nearest Neighbor Spatial Distance (meters)"}
...
```{r epsTimeDist, echo=FALSE, cache=FALSE, class.source="chunk",fig.align="center",fig.cap="<b>Figure 5: </b>Sorted Nearest Neighbor Temporal Distance (seconds)"}
...
```{r initial_clusterWorkflow, class.source='chunk', eval=FALSE, fig.cap=""}
...
```{r initial_clusterWorkflow_quickLook, class.source='chunk', cache=TRUE, fig.cap=""}
# Quick look
...
```{r plottingFunc, cache=FALSE, include=FALSE, class.source='chunk'}
...
baseLeaf(groups2hide=c("Observations",processed_dt[,unique(group)] %>% 
                       sort() %>% 
